...
export default function RootLayout() {
  ...
  if (triggerError) {
    throw new Error(
      "Erro de depuração provocado intencionalmente via botão 'BUG' na barra inferior! 🐛",
    );
  }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="bg-neo-black p-2">
                <Zap className="text-neo-lime w-6 h-6" />
              </div>
              <NavLink
                to="/"
                className="font-heading font-black text-2xl uppercase tracking-tighter hover:text-neo-pink transition-colors"
              >
                MATCH_TECH
              </NavLink>
            </div>
        ...
        <div className="fixed inset-0 bg-neo-black/60 backdrop-blur-sm z-[999] flex items-center justify-center p-4">
          <div className="bg-white border-[4px] border-neo-black p-6 md:p-8 max-w-sm w-full shadow-[8px_8px_0_0_#000] relative animate-in zoom-in-95 duration-150">
            ...
            <p className="font-bold text-sm text-neo-black/70 mb-6">
              Sua sessão será encerrada e você precisará logar novamente para acessar seu perfil e
              sintonizar sua Sina.
            </p>
